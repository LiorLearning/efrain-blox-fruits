...
export class LightFruit extends Fruit {
        ...
        return this._useAttack('Solar Flare', position, direction, (pos, dir) => {
            ...
            if (solarFlare) {
                ...
                solarFlare.userData.update = function(deltaTime) {
                    ...
                    this.checkEnemiesInRange(solarFlare.position, solarFlare.userData.radius, 
                        this.power * deltaTime, 'light');
    ...
    _createLightParticle(position, size = 0.2) {
        // Use the centralized particle system
        return this.createParticle(position, {
            ...
            addLight: Math.random() < 0.3, // Only some particles get lights for performance
            lightIntensity: 0.5,
            lightDistance: 3
        });
    }
